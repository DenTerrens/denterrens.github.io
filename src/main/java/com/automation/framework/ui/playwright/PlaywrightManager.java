...
public final class PlaywrightManager {
    ...
    public static void start() {
        ...
        LOGGER.info("Starting Playwright browser session with browser={} headless={}", browserName, ConfigManager.getBoolean("headless"));
        ...
        BrowserContext browserContext = browser.newContext(new Browser.NewContextOptions().setViewportSize(1440, 960));
